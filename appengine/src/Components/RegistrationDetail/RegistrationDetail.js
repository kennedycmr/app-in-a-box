//================================================================
//  Component: Registration Detail 
//================================================================

//  Purpose: This is the Registration Detail which appears in the My Events tab. 
//           This component appears when the user clicks on an event under Registered Events

//  Properties:
//    - selectedEvent = {string, the selected event}
//    - setSelectedEvent = {string, sets the tile to the selected event}
//    - setRequestType = {string, sets the page to the page type}
//    - requestType = {string, page type}
        ...
        <div className='RegistrationDetail-Body'>   
            ...
            <Table>
                <thead>
                    ...
                    <tr>
                        <th>Ics File</th>
                        <td> <a href={selectedEvent?.icsurl} rel='noreferrer' target='_blank' style={{textDecoration:'none'}}>Download here</a></td>
                    </tr>
                </thead>
            </Table>
